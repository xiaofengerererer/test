...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r"C:\Users\87991\Desktop\qxf\yolov5-5.0\runs\train\4500\fuse_pic\weights\best.pt", help='model.pt path(s)')
