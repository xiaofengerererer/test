    ...
    with open(txt, 'r') as f:
        ...
        for line in lines:
            for boxes in line:
                ...
                if object_name == 'ignored regions' or object_name == 'others':
                    continue
...
if __name__ == '__main__':
    ...
    txt_folder = r'C:\Users\87991\Downloads\VisDrone2019-DET-train\annotations'  # visdrone txt标签文件夹
    txt_file = os.listdir(txt_folder)
    img_folder = r'C:\Users\87991\Downloads\VisDrone2019-DET-train\images'  # visdrone 照片所在文件夹
