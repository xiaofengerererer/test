    ...
    for i, name in enumerate(files):
        ...
        for row in txtList:
            ...
            if img_name != pre_img_name:
                ...
                xml_file.write('            <xmin>' + str(oneline[1]) + '</xmin>\n')
                xml_file.write('            <ymin>' + str(oneline[2]) + '</ymin>\n')
                xml_file.write('            <xmax>' + str(oneline[3]) + '</xmax>\n')
                xml_file.write('            <ymax>' + str(oneline[4]) + '</ymax>\n')
...
txt_path= '../VOCdevkit/VOC2007/YOLOlabels/'
